...
var O = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (t, o) => (typeof __require < "u" ? __require : t)[o] }) : e)(function(e) {
...
var ee = ["args"];
var te = ["evalOrigin"];
var I = w.concat(N, _, ee, te);
function p(e) {
  if (e) for (var t = 0; t < I.length; t++) e[I[t]] !== void 0 && this["set" + E(I[t])](e[I[t]]);
}
c(p, "StackFrame");
...
var A = g && typeof module < "u" && typeof module.exports < "u" && typeof O < "u" && typeof __dirname < "u";
var W = g && !A;
...
var D;
async function T() {
  if (!g || (V = (await import("./node_url-VMBKG23O.js")).default, H = await import("./node_fs-23V4EMJG.js"), D = await import("./promises-K5HYVQP3.js"), z = (await import("./node_vm-JYILYGKA.js")).default, L = await import("./node_path-NZFCBJUN.js"), U = L.sep, typeof O < "u")) return;
